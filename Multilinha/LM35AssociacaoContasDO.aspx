            ...
            <div id="camposChave" runat="server">
                ...
                <div class="row form-group padding-row ">
                    <div class="col-sm-6">
                        ...
                        <div class="col-sm-3">
                            <asp:TextBox ID="txtidmultilinha" Enabled="false" ReadOnly="false" MaxLength="12" pattern="[A-Za-z0-9]{12}" title="Deve inserir um código alfanumérico com doze posições" oninvalid="setCustomValidity('Deve inserir um código alfanumérico com doze posições')"
