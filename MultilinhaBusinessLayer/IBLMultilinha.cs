...
namespace MultilinhaBusinessLayer
{
    ...
    public interface IBLMultilinha
    {
        ...
        [OperationContract]
        MensagemOutput<LM31_CatalogoProdutoML> LM31Request(LM31_CatalogoProdutoML _lm31, ABUtil.ABCommandArgs abargs, string accao, bool pedido);

        [OperationContract]
        MensagemOutput<LM33_ContratoML> LM33Request(LM33_ContratoML _LM33, ABUtil.ABCommandArgs abargs, string accao, string acesso, bool pedido);
        ...
        [OperationContract]
        MensagemOutput<LM37_SimulacaoMl> LM37Request(LM37_SimulacaoMl _LM33, ABUtil.ABCommandArgs abargs, string accao, bool pedido);

        [OperationContract]
        MensagemOutput<LM38_HistoricoAlteracoes> LM38Request(LM38_HistoricoAlteracoes _LM33, ABUtil.ABCommandArgs abargs, string accao, bool pedido);
    }
}
